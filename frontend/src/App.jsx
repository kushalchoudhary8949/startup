...
const API_BASE = "https://startup-backend.onrender.com/api";
...
```
try {
  const { data } = await axios.post(`${API_BASE}/analyze`, { idea });
  setResult(data);
...
return ( <div className="relative min-h-screen"> <div className="max-w-3xl mx-auto px-4 py-12">

```
    <h1 style={{ fontSize: "32px", fontWeight: "800", textAlign: "center" }}>
      Startup Detector
    </h1>
    ...
    {result && !loading && (
      <div>
        ...
        <div style={{ marginTop: "20px", marginBottom: "20px" }}>
          <strong>Idea:</strong> {analyzedIdea}
        </div>

        <button onClick={handleSaveIdea} disabled={isSaving || saveSuccess}>
        ...
        <div style={{ marginTop: "20px" }}>
          ...
          {activeTab === "mvp" && (
            <MVPPlan mvp_plan={result.mvp_plan} />
          )}
